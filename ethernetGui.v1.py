...
class MarconiNode:
    def __init__(self, root):
        ...
        self.max_graph_pwr = THRESHOLD * 4 # Adjust this if your signal regularly blows past the end of the bar
        ...
        self.thresh_x = (THRESHOLD / self.max_graph_pwr) * 300
...
#        threading.Thread(target=self.receiver_loop, daemon=True).start()
    ...
    def update_power_meter(self, pwr):
        ...
        def draw():
            ...
            color = "lime" if pwr > THRESHOLD else "blue"
    ...
    def receiver_loop(self):
        ...
        while True:
            ...
            self.channel_busy = (pwr > THRESHOLD)
